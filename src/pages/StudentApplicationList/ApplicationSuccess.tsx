  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4">
      <div className="max-w-xl w-full text-center space-y-6">
        {/* Success Icon */}
        <div className="mb-8">
          <div className="h-16 w-16 rounded-full border flex items-center justify-center mx-auto">
        ...
        <div className="flex flex-col sm:flex-row justify-center gap-4 pt-8">
          <Button variant="outline" className="px-8" onClick={() => navigate('/student-application-list')}>
            View Applications
          </Button>
