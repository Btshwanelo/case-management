...
import { Info, Mail, Phone, SaveIcon, SaveOffIcon } from 'lucide-react';
...
const EntityProfileDetails = ({ details, contactDetails, nextOfKin, setNextStep }) => {
  ...
  useEffect(() => {
    // form.setValue('IDNumber', details?.idNumber);
    ...
    form.setValue('RegistrationNo', details?.registrationNo);
  ...
  useEffect(() => {
    if (isSuccessConfirm) {
      ...
      form.setValue('RegistrationNo', dataConfirm?.profileDetails?.details?.registrationNo);
    }
  }, [isSuccessConfirm]);
  ...
  const handleRequestOTP = (type: string) => {
    setOtpType(type);
    const OTP_EXPIRY_KEY = 'profileEOtpGenerateExpiry';
          ...
          <CardContent className="pt-6">
            ...
            {/* <Alert className="mb-6 bg-red-50 border-red-200">
              <div className="flex justify-between items-center gap-6">
                <AlertDescription className="flex items-center font-medium gap-2 text-red-600">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <div className="mb-2">
                      ...
                      <p className="text-sm text-gray-500">View and manage your company details here.</p>
                    </div>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input disabled {...form.register('Name', { required: true })} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input disabled {...form.register('RegistrationName', { required: true })} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input disabled {...form.register('RegistrationNo', { required: true })} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input disabled {...form.register('VATNumber', { required: true })} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <FormControl>
                              <Input disabled={isLocked} {...form.register('Mobile', { required: true })} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
