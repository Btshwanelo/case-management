...
const StudentContactDetails = ({ personName = '{person.name}', onNext }) => {
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input id="emailAddress" name="emailAddress" placeholder="Email" value={formData.emailAddress} onChange={handleChange} />
