...
const SelfieIntroScreen = ({ onNextStep, onBack, onClose }) => {
      ...
      <div className="w-full max-w-3xl mx-auto p-4">
        ...
        <CardContent className="space-y-8 pt-1">
          <div className="text-center space-y-2">
            <h1 className="text-2xl font-semibold text-gray-900">Take a Selfie</h1>
        ...
        <CardFooter className="pt-4">
          <Button className="w-full bg-orange-600 hover:bg-orange-700 text-white py-2 text-lg font-medium rounded-md" onClick={onNextStep}>
            Continue
          </Button>
        </CardFooter>
      </div>
