...
const DOCUMENT_TYPES: DocumentType[] = [
  ...
  {
    id: EUploadDocumentType.ElectricalCertificate,
    label: 'Electrical Certificate of Compliance',
    description: 'Electrical Certificate of Compliance',
    acceptedFormats: ['.pdf', '.jpg', '.jpeg', '.png'],
  },
  {
    id: EUploadDocumentType.FireCertificate,
    label: 'Fire Certificate of Compliance	',
    description: 'Fire Certificate of Compliance	',
    acceptedFormats: ['.pdf', '.jpg', '.jpeg', '.png'],
  },
];
...
const UploadPropertyDocuments = () => {
  ...
  useEffect(() => {
    if (isSuccess) {
      if (residentDetails.fullEdit === false) {
          ...
          <div className="lg:col-span-9">
            <Card>
              ...
              <CardContent className="space-y-6">
                ...
                {!PrevDataIsLoading && files.length < DOCUMENT_TYPES.length && (
